...
TABLES_INFORMATION_RAW = {
    'bets': {
        'schema':{
            ...
            "ruben"         : pl.Int32,    # Nuevos - min 0 max 1 tinyint (probablemente binario)
            ...
            "locationId"    : pl.Int32,     # Nuevos  - No hay datos en la tabla pero esta definido como int
            "tstamp"        : pl.String, 
            ...
            "extRefID"      : pl.Int64,     # Nuevos - No hay datos en la tabla pero esta definido como BigInt
            "delAccountID"  : pl.String,     # Nuevos - No hay datos en la tabla pero esta definido como Varchar 50
            "lastCashBalance": pl.Float32,    # Nuevos - No hay datos en la tabla pero esta definido como decimal
